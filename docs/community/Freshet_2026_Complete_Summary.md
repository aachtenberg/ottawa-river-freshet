...
**The unexplained 52 cm residual is consistent with the documented 30–50 cm Bryson headpond rise** confirmed in the November 2025 MRC Pontiac notice and the Hydro-Québec acknowledgement that refurbishment "may therefore change the water head value." This does not prove causation, but the magnitude of the unexplained component matches the magnitude of the documented operational change.
...
**Has the post-refurbishment operating range of Bryson Dam been changed from the pre-2017 normal? If so, was the impact on Lac Coulonge flood buffer evaluated before the change was made?**

Hydro-Québec acknowledges that refurbishment changes water head values. ORRPB acknowledges that higher headponds are more efficient for hydropower. The November 2025 notice confirmed a 30–50 cm rise was tested. The regression analysis shows post-2017 peaks are running 52 cm higher than pre-2017 precipitation patterns predict — quantitatively consistent with the documented 30–50 cm headpond rise. But neither agency has publicly disclosed whether the post-refurbishment "normal operating range" matches the pre-2017 one — or, if not, what flood-buffer analysis informed the change.
...
The climate alternative explanation was tested rigorously using 45 years (1972–2016) of cold-season precipitation at Ottawa station and Lac Coulonge yearly peaks. Pre-2017 vs post-2017 cold-season precipitation differed by only +3% (412 → 423 mm, t=0.46, not significant). A linear regression model trained on pre-2017 data predicted post-2017 peaks; actual peaks averaged 52 cm higher than the model predicted. The four super-flood years showed residuals of +86 cm (2017), +161 cm (2019), +110 cm (2023), and +79 cm (2025). The unexplained 52 cm residual is consistent in magnitude with the documented 30–50 cm Bryson headpond rise (MRC Pontiac notice, November 2025). The Ottawa station explains only ~14% of Lac Coulonge peak variance, so this is a conservative test — cleaner upstream precipitation data would likely produce an even stronger signal. **Conclusion:** Climate change in the southern Ottawa basin is real and measurable, but does not by itself explain the regime change at Lac Coulonge. The unexplained component is consistent with operational changes at Bryson Dam.
